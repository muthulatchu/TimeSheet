package com.minuscule.timesheet.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("TimeSheetApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("TimeSheetApp");
        ...
        config.getMapConfigs().put("com.minuscule.timesheet.domain.*", initializeDomainMapConfig(jHipsterProperties));
